...
describe('OllamaService', () => {
  ...
  describe('setActiveModel', () => {
    ...
    it('should throw error when model does not exist', async () => {
      ...
      await expect(service.setActiveModel('nonexistent:model')).rejects.toThrow(
  ...
  describe('generateSummary', () => {
    ...
    it('should throw error when service is not available', async () => {
      ...
      await expect(
        service.generateSummary('test content', mockSummaryOptions)
  ...
  describe('cancelGeneration', () => {
    it('should not throw error for non-existent operation', async () => {
      await expect(
        service.cancelGeneration('nonexistent-id')
